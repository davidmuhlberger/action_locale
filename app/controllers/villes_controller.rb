class VillesController < ApplicationController
  ...
  def show_depenses
    ...
    @charges_investissement_2017 = @comptes_2017[:depenses_equipement_2].to_i+@comptes_2017[:subventions_equipement_versees_2].to_i+@comptes_2017[:autres_depenses_equipement_1].to_i+@comptes_2017[:autres_depenses_equipement_2].to_i+@comptes_2017[:depenses_operations_tiers_4].to_i
    @charges_investissement_moy_2017 = @comptes_moy_2017[:depenses_equipement_2].to_i+@comptes_moy_2017[:subventions_equipement_versees_2].to_i+@comptes_moy_2017[:autres_depenses_equipement_1].to_i+@comptes_moy_2017[:autres_depenses_equipement_2].to_i+@comptes_moy_2017[:depenses_operations_tiers_4].to_i
  ...
  def show_finances
    ...
    if @ville[:metropole] == "MGP"
      @charges_fonctionnement_2017 = @comptes_2017[:achats_charges_externes_6].to_i+@comptes_2017[:autres_6].to_i+@comptes_2017[:exceptionnel_6].to_i+@comptes_2017[:frais_elus_6].to_i+@comptes_2017[:frais_financiers_6].to_i+@comptes_2017[:impots_6].to_i+@comptes_2017[:intervention_hors_suventions_6].to_i+@comptes_2017[:personnel_6].to_i+@comptes_2017[:subventions_versees_6].to_i
    else
      @charges_fonctionnement_2017 = @comptes_2017[:achats_charges_externes_6].to_i+@comptes_2017[:autres_6].to_i+@comptes_2017[:exceptionnel_6].to_i+@comptes_2017[:frais_elus_6].to_i+@comptes_2017[:frais_financiers_6].to_i+@comptes_2017[:impots_6].to_i+@comptes_2017[:intervention_hors_suventions_6].to_i+@comptes_2017[:personnel_6].to_i+@comptes_2017[:subventions_versees_6].to_i+@comptes_2017[:fonds_compensation_charges_territoriales_6].to_i
    end


    @charges_fonctionnement_moy_2017 = @comptes_moy_2017[:achats_charges_externes_6].to_i+@comptes_moy_2017[:autres_6].to_i+@comptes_moy_2017[:exceptionnel_6].to_i+@comptes_moy_2017[:frais_elus_6].to_i+@comptes_moy_2017[:frais_financiers_6].to_i+@comptes_moy_2017[:impots_6].to_i+@comptes_moy_2017[:intervention_hors_suventions_6].to_i+@comptes_moy_2017[:personnel_6].to_i+@comptes_moy_2017[:subventions_versees_6].to_i
    @charges_fonctionnement_2016 = @comptes_2016[:achats_charges_externes_6].to_i+@comptes_2016[:autres_6].to_i+@comptes_2016[:exceptionnel_6].to_i+@comptes_2016[:frais_elus_6].to_i+@comptes_2016[:frais_financiers_6].to_i+@comptes_2016[:impots_6].to_i+@comptes_2016[:intervention_hors_suventions_6].to_i+@comptes_2016[:personnel_6].to_i+@comptes_2016[:subventions_versees_6].to_i
    @charges_fonctionnement_moy_2016 = @comptes_moy_2016[:achats_charges_externes_6].to_i+@comptes_moy_2016[:autres_6].to_i+@comptes_moy_2016[:exceptionnel_6].to_i+@comptes_moy_2016[:frais_elus_6].to_i+@comptes_moy_2016[:frais_financiers_6].to_i+@comptes_moy_2016[:impots_6].to_i+@comptes_moy_2016[:intervention_hors_suventions_6].to_i+@comptes_moy_2016[:personnel_6].to_i+@comptes_moy_2016[:subventions_versees_6].to_i
    @charges_fonctionnement_2015 = @comptes_2015[:achats_charges_externes_6].to_i+@comptes_2015[:autres_6].to_i+@comptes_2015[:exceptionnel_6].to_i+@comptes_2015[:frais_elus_6].to_i+@comptes_2015[:frais_financiers_6].to_i+@comptes_2015[:impots_6].to_i+@comptes_2015[:intervention_hors_suventions_6].to_i+@comptes_2015[:personnel_6].to_i+@comptes_2015[:subventions_versees_6].to_i
    @charges_fonctionnement_moy_2015 = @comptes_moy_2015[:achats_charges_externes_6].to_i+@comptes_moy_2015[:autres_6].to_i+@comptes_moy_2015[:exceptionnel_6].to_i+@comptes_moy_2015[:frais_elus_6].to_i+@comptes_moy_2015[:frais_financiers_6].to_i+@comptes_moy_2015[:impots_6].to_i+@comptes_moy_2015[:intervention_hors_suventions_6].to_i+@comptes_moy_2015[:personnel_6].to_i+@comptes_moy_2015[:subventions_versees_6].to_i
    @charges_fonctionnement_2014 = @comptes_2014[:achats_charges_externes_6].to_i+@comptes_2014[:autres_6].to_i+@comptes_2014[:exceptionnel_6].to_i+@comptes_2014[:frais_elus_6].to_i+@comptes_2014[:frais_financiers_6].to_i+@comptes_2014[:impots_6].to_i+@comptes_2014[:intervention_hors_suventions_6].to_i+@comptes_2014[:personnel_6].to_i+@comptes_2014[:subventions_versees_6].to_i
    @charges_fonctionnement_moy_2014 = @comptes_moy_2014[:achats_charges_externes_6].to_i+@comptes_moy_2014[:autres_6].to_i+@comptes_moy_2014[:exceptionnel_6].to_i+@comptes_moy_2014[:frais_elus_6].to_i+@comptes_moy_2014[:frais_financiers_6].to_i+@comptes_moy_2014[:impots_6].to_i+@comptes_moy_2014[:intervention_hors_suventions_6].to_i+@comptes_moy_2014[:personnel_6].to_i+@comptes_moy_2014[:subventions_versees_6].to_i
    @charges_fonctionnement_2013 = @comptes_2013[:achats_charges_externes_6].to_i+@comptes_2013[:autres_6].to_i+@comptes_2013[:exceptionnel_6].to_i+@comptes_2013[:frais_elus_6].to_i+@comptes_2013[:frais_financiers_6].to_i+@comptes_2013[:impots_6].to_i+@comptes_2013[:intervention_hors_suventions_6].to_i+@comptes_2013[:personnel_6].to_i+@comptes_2013[:subventions_versees_6]
    @charges_fonctionnement_moy_2013 = @comptes_moy_2013[:achats_charges_externes_6].to_i+@comptes_moy_2013[:autres_6].to_i+@comptes_moy_2013[:exceptionnel_6].to_i+@comptes_moy_2013[:frais_elus_6].to_i+@comptes_moy_2013[:frais_financiers_6].to_i+@comptes_moy_2013[:impots_6].to_i+@comptes_moy_2013[:intervention_hors_suventions_6].to_i+@comptes_moy_2013[:personnel_6].to_i+@comptes_moy_2013[:subventions_versees_6].to_i
    @charges_fonctionnement_2012 = @comptes_2012[:achats_charges_externes_6].to_i+@comptes_2012[:autres_6].to_i+@comptes_2012[:exceptionnel_6].to_i+@comptes_2012[:frais_elus_6].to_i+@comptes_2012[:frais_financiers_6].to_i+@comptes_2012[:impots_6].to_i+@comptes_2012[:intervention_hors_suventions_6].to_i+@comptes_2012[:personnel_6].to_i+@comptes_2012[:subventions_versees_6].to_i
    @charges_fonctionnement_moy_2012 = @comptes_moy_2012[:achats_charges_externes_6].to_i+@comptes_moy_2012[:autres_6].to_i+@comptes_moy_2012[:exceptionnel_6].to_i+@comptes_moy_2012[:frais_elus_6].to_i+@comptes_moy_2012[:frais_financiers_6].to_i+@comptes_moy_2012[:impots_6].to_i+@comptes_moy_2012[:intervention_hors_suventions_6].to_i+@comptes_moy_2012[:personnel_6].to_i+@comptes_moy_2012[:subventions_versees_6].to_i

    if @ville[:metropole] == "MGP"
      @produits_fonctionnement_2017 = @comptes_2017[:autres_impots_taxes_7].to_i+@comptes_2017[:autres_produits_fonctionnement_7].to_i+@comptes_2017[:dotations_etat_7].to_i+@comptes_2017[:fiscalite_reversee_7].to_i+@comptes_2017[:impots_locaux_7].to_i+@comptes_2017[:produits_cessions_7].to_i+@comptes_2017[:produits_fonctionnement_exceptionnels_7].to_i+@comptes_2017[:suventions_participations_7].to_i+@comptes_2017[:ventes_biens_services_7].to_i+@comptes_2017[:fonds_compensation_charges_territoriales_6].to_i
    else
      @produits_fonctionnement_2017 = @comptes_2017[:autres_impots_taxes_7].to_i+@comptes_2017[:autres_produits_fonctionnement_7].to_i+@comptes_2017[:dotations_etat_7].to_i+@comptes_2017[:fiscalite_reversee_7].to_i+@comptes_2017[:impots_locaux_7].to_i+@comptes_2017[:produits_cessions_7].to_i+@comptes_2017[:produits_fonctionnement_exceptionnels_7].to_i+@comptes_2017[:suventions_participations_7].to_i+@comptes_2017[:ventes_biens_services_7].to_i
    end
  ...
  def find_years
    if @ville.annees.where(annee: 2017).first
      @comptes_2017 = @ville.annees.where(annee: 2017).first
    else
    end
    ...
    if @ville_moy.annees.where(annee: 2017).first
      @comptes_moy_2017 = @ville_moy.annees.where(annee: 2017).first
    else
    end
